...
<html>
	...
	<title>Course|Get in Touch</title>
			...
			<div class="row">
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">kWatt Solutions Private Limited <br>A-215, Eastern Business District <br>LBS Marg Bhandup West<br>Mumbai -400078.</li>
							<li class="phone"><a href="#">022-67208033</a></li>
							<li class="email"><a href="mailto:info@kwattsolutions.com">info@kwattsolutions.com</a></li>
