...
.close:focus {
	...
	if(! $conn ) {
		 ...
		 echo" <form method='POST' action='result_mcq.php' >
            ...
            $i=0;
                ...
                <center> <a href='video_course.php?item=".$image_item."'>Go back to Course</a></center>
                <hr style='padding-bottom:10px padding-top:10px'>
                <center>
                <p> Solve the Final test for certifications</p>
                <a href='final_mcq.php' ><input type='button' class='btn btn-primary'value='Final Assesment'></a></center>";
